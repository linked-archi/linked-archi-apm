...
| `vocabulary.ttl` | 749 | 0 | Published vocabulary: BPMN taxonomy, plus the core property axioms. |
| `shapes.ttl` | 3311 | 0 | Published SHACL: which relationship may connect which types. |
...
749 triples of Turtle in the **default graph**, and both halves of that matter. Turtle
